"""
Django settings for damp_union_dev_63837 project.
...
ROOT_URLCONF = 'damp_union_dev_63837.urls'
...
WSGI_APPLICATION = 'damp_union_dev_63837.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "damp_union_dev_63837 API",
    "DESCRIPTION": "API documentation for damp_union_dev_63837 App",
    "VERSION": "v1",
}
